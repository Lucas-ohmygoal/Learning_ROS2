...
#ifndef LEARNING_INTERFACE__SRV__DETAIL__ADD_TWO_INTS__FUNCTIONS_H_
#define LEARNING_INTERFACE__SRV__DETAIL__ADD_TWO_INTS__FUNCTIONS_H_
 ...
 * calls
 * learning_interface__srv__AddTwoInts_Request__init().
...
/**
 * It calls
 * learning_interface__srv__AddTwoInts_Request__fini()
 ...
 * learning_interface__srv__AddTwoInts_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * learning_interface__srv__AddTwoInts_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * learning_interface__srv__AddTwoInts_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_learning_interface
...
/**
 * It calls
 * learning_interface__srv__AddTwoInts_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_learning_interface
...
/**
 * It allocates the memory for the array and calls
 * learning_interface__srv__AddTwoInts_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_learning_interface
...
/**
 * It calls
 * learning_interface__srv__AddTwoInts_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // LEARNING_INTERFACE__SRV__DETAIL__ADD_TWO_INTS__FUNCTIONS_H_
