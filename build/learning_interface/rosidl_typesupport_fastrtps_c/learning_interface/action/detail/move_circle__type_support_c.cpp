...
{
  return max_serialized_size_learning_interface__action__MoveCircle_Goal(
    full_bounded, 0);
}
...
{
  return max_serialized_size_learning_interface__action__MoveCircle_Result(
    full_bounded, 0);
}
...
{
  return max_serialized_size_learning_interface__action__MoveCircle_Feedback(
    full_bounded, 0);
}
...
{
  return max_serialized_size_learning_interface__action__MoveCircle_SendGoal_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_learning_interface__action__MoveCircle_SendGoal_Response(
    full_bounded, 0);
}
...
{
  return max_serialized_size_learning_interface__action__MoveCircle_GetResult_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_learning_interface__action__MoveCircle_GetResult_Response(
    full_bounded, 0);
}
...
{
  return max_serialized_size_learning_interface__action__MoveCircle_FeedbackMessage(
    full_bounded, 0);
}
